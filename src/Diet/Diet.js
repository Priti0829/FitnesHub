...
function Diet() {
  ...
  /*const handleHeightChange = (event) => {
    setHeightLevel(event.target.value);
  };
*/
...
*/
  ...
  /*const handleSubmit = (event) => {
    ...
    // You can access form fields values like name, city, age, etc., from their respective state variables
    ...
    <div className="Diet">
      <form onSubmit={handleGenerate}>
        ...
        <div>
          ...
          <br />
          <input type="text" id="sugar" name="sugar" value={sugar} /*onChange={handleheightChange}*/ />
        </div>
        <br />
        {/*Generate button */}
